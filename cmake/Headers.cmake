...
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCMathFoundation-import.h")
   set( PUBLIC_HEADERS
      "src/_MulleObjCMathFoundation-import.h"
      ${PUBLIC_HEADERS}
   )
endif()
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCMathFoundation-include.h")
   set( PUBLIC_HEADERS
      "src/_MulleObjCMathFoundation-include.h"
      ${PUBLIC_HEADERS}
   )
endif()
...
# add ignored headers back in so that the generators pick them up
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCMathFoundation-import-private.h")
   set( PRIVATE_HEADERS
      "src/_MulleObjCMathFoundation-import-private.h"
      ${PRIVATE_HEADERS}
   )
endif()
if( EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/_MulleObjCMathFoundation-include-private.h")
   set( PRIVATE_HEADERS
      "src/_MulleObjCMathFoundation-include-private.h"
      ${PRIVATE_HEADERS}
   )
endif()
